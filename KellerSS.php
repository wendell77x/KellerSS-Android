<?php
// Instalar PHP automaticamente
system("pkg install php -y");

// Configuração do terminal
system("stty cols 80 rows 24");
system("clear");

echo "\033[1mKellerSS Android \033[1;36mFucking Cheaters\033[0m discord.gg/allianceoficial\n\n";
echo "\n";
echo "\n";
echo "\033[1;31m                           )       (     (          (\n";
echo "                        ( /(       )\ )  )\ )       )\ )\n";
...
echo "      +                       KellerSS Menu                          +\n";
echo "      +--------------------------------------------------------------+\033[0m\n\n";
echo "\033[1;33m [0]  Instalar Módulos\033[0m (Atualizar e instalar módulos)\n";
...
echo "\033[1;32m[i] Data e hora automáticas estão ativadas.\033[0m\n";
echo "\n";
echo "\n";
echo "\033[1;34m             [+] Primeira log do sistema: 03-30 18:57:35\033[0m\n";
echo "\033[1m[+] Caso a data da primeira log seja durante/após a partida, aplique o W.O![0m\n";
echo "\n";
echo "\033[1;34m[+] Verificando mudanças de data/hora...\033[0m\n";
echo "\n";
echo "\033[1;34mDeprecated: trim(): Passing null to parameter #1 (\$string) of type string is deprecated in /data/data/com.termux/files/home/KellerSS-Android/KellerSS.php on line 2\033[0m\n";
...
echo "\n";
echo "\033[1;32m[+] Verificando datas de modificação na pasta 'android'...\033[0m\n";
echo "\033[1;32m[i] Modificação: 2025-03-18 22:48:40\033[0m\n";
